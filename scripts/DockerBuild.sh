...
docker run -p 8080:8080 --name tomcat-1 412937381715.dkr.ecr.ap-northeast-1.amazonaws.com/spring-images:latest
docker stop tomcat-2 || true && docker rm tomcat-2 || true
docker run -p 8081:8080--name tomcat-2 412937381715.dkr.ecr.ap-northeast-1.amazonaws.com/spring-images:latest
docker stop tomcat-3 || true && docker rm tomcat-3 || true
docker run -p 8082:8080 --name tomcat-3 412937381715.dkr.ecr.ap-northeast-1.amazonaws.com/spring-images:latest
