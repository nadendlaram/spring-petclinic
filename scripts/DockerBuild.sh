...
docker run -p 3000:3000 --name tomcat-1 412937381715.dkr.ecr.ap-northeast-1.amazonaws.com/spring-images:latest
docker stop tomcat-2 || true && docker rm tomcat-2 || true
docker run -p 3001:3000--name tomcat-2 412937381715.dkr.ecr.ap-northeast-1.amazonaws.com/spring-images:latest
docker stop tomcat-3 || true && docker rm tomcat-3 || true
docker run -p 3002:3000 --name tomcat-3 412937381715.dkr.ecr.ap-northeast-1.amazonaws.com/spring-images:latest
